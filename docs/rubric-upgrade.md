...
Scope: deployed and production-revalidated public version 8 compared with public version 7.

These are evidence-based internal estimates, not predictions of an individual judge's score.

| Official criterion    | deployed v7 | deployed v8 | Evidence for the change                                                                                                                                                                                                                                                                   |
| --------------------- | ----------: | ----------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
- **DEPLOYED:** Sites version 8 deployment `appgdep_6a909f7cf6fc8191bdce65fbc0d5b3f1` succeeded from exact source checkpoint `222af335c9bb98333cc515d154148154d0e6fa53`; unauthenticated HTTPS returned `200`.
- **TESTED:** the deployed origin registered the nine incident-dependent pre-approval tools, returned the generated checkout graph and telemetry through real `document.modelContext`, kept `apply_approved_mitigation` absent, and recorded zero console errors or warnings.
...
- **DEPLOYED:** Sites version 8 deployment `appgdep_6a909f7cf6fc8191bdce65fbc0d5b3f1` succeeded from exact source checkpoint `222af335c9bb98333cc515d154148154d0e6fa53` and passed deployed-origin WebMCP revalidation.
